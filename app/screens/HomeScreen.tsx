...
const HomeScreen = () => {
  ...
  // Custom empty component for pets
  ...
  // Custom empty component for products
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        {/* Pets Section - Using PetList Component */}
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
        ...
        {/* Products Section - Using ProductList Component */}
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
...
const styles = StyleSheet.create({
  ...
  // Pet list content style for the PetList component
  petListContent: {
    paddingHorizontal: 20,
  },

  // Product list content style for the ProductList component
  productListContent: {
    paddingHorizontal: 20,
  },
